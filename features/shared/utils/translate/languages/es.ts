export const es = {
  ...
  landing: {
    ...
    goodbyeSubtitle: "¡Nos vemos el próximo año!",
    feedbackDescription: "Por favor, comparte tus valiosas opiniones para que podamos volver con un mejor servicio el próximo año.",
    feedbackButton: "Dejar comentarios",
  },
  help: {
    title: "Cómo usar",
    section1: {
