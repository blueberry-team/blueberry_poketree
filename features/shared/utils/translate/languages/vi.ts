export const vi = {
  ...
  guide: {
    ...
    page5: "Su dung nut nay de xem tat ca Tin nhan Pocket ban da nhan cho den bay gio.\n\nBan cung co the cong khai chung cho moi nguoi xem!",
    page6: "Su dung nut nay de kiem tra cac Pokemon ban da thu thap.\n\nThu thap tat ca Pokemon de tro thanh Bac thay Pokemon!",
    page7: "Vay la tat ca bay gio.\nToi hy vong ban thich PokéTree!\n\nGiang sinh vui ve!",
